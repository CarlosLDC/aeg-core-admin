      ...
      <section className="rounded-xl border border-border bg-card p-5 shadow-sm">
        <div className="flex items-start justify-between gap-3">
          ...
          <button
            ...
            className="inline-flex shrink-0 items-center gap-1.5 rounded-lg border border-border px-3 py-1.5 text-xs font-medium hover:bg-foreground/5 disabled:opacity-50"
          >
            {probeLoading ? (
      ...
      <section className="rounded-xl border border-border bg-card p-5 shadow-sm">
        ...
        <form onSubmit={handlePublish} className="mt-4 space-y-4">
          ...
          <button
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-accent px-4 py-2.5 text-sm font-medium text-accent-foreground hover:bg-accent/90 disabled:opacity-70"
          >
            {publishLoading && (
