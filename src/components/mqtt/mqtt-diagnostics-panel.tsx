  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:flex-nowrap md:items-center md:justify-between">
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-1 text-sm text-muted">
              Verifica que el servidor pueda alcanzar el broker MQTT (TCP).
            </p>
          </div>
      ...
      <section className="rounded-xl border border-border bg-card p-5 shadow-sm">
        ...
        <p className="mt-1 text-sm text-muted">
          Envía un tópico y payload JSON al broker vía{" "}
          <code className="text-xs">POST /api/mqtt/publish</code>. Al pegar JSON
          válido se formatea automáticamente.
        </p>
