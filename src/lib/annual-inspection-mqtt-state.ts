...
/** Tras factura de prueba exitosa: guarda número y marca el checklist de factura. */
...
/** Tras error en factura de prueba: limpia número y desmarca factura/NC dependientes. */
...
/** Tras NC de prueba exitosa: marca el checklist correspondiente. */
...
/** Tras error en NC de prueba: desmarca solo el checklist de NC. */
...
/** Cambio de producto invalida la factura/NC ya obtenidas. */
export function applyProductDescriptionChange(
  flow: AnnualInspectionMqttFlowState,
  productDescription: string,
): AnnualInspectionMqttFlowState {
  if (flow.productDescription === productDescription) {
    return flow;
  }
  return {
    ...flow,
